...
const TextField: React.FC<Props> = ({
  ...
  /*Unlike React Js, in React TS, we cannot set a default state of number to null, or null to number etc... If we are to allow multiple data types for a state, we need to explicitly set it using the angle brackets and the OR pipe i.e |. So for the name state, the state can be a string, null or undefined.. N.B Undefine is a type on its own which is different from null */
  ...
  /*handle onChange event of an input field using e: ChangeEvent<HTMLInputElement> */
